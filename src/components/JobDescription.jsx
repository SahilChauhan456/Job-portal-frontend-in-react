      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">
          ...
          <span className="pl-4 font-normal text-gray-800">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum libero corporis deserunt nobis repellat aspernatur minima quisquam ad harum tenetur!
          </span>
        </h1>
        <h1 className="font-bold my-1">
        ...
        <h1 className="font-bold my-1">
          Posted Date: <span className="pl-4 font-normal text-gray-800">17-07-2026</span>
        </h1>
      </div>
    </div>
  );
